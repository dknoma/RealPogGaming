...
public class TopDownPlayerOrder : MonoBehaviour {
	...
	private void Update() {
		...
		platformSortOrder = (int) (character.GetCurrentPlatform() != null 
									&& character.currentHeight >= character.GetCurrentPlatform().height 
									&& Mathf.Round(character.GetCurrentPlatform().height) > 0
