...
public class ActionMenuEventSystemManager : MonoBehaviour {

	public static ActionMenuEventSystemManager amm;
...
//				UIManager.um.EnableMainActionMenu();
////                SetMenuActive(_actionMenu,true);
////				SetButtonsInteractable(_actionMenu, true);
//				eventSystem.SetSelectedGameObject(UIManager.um.GetDefaultMainAction());
