...
public class PlayerController : MonoBehaviour {
	...
	private void TryBlockDirections(Rigidbody2D rb2d, Vector2 direction) {
		...
		switch (facingDirection) {
			case Direction.Up:
				rb2d.Cast(Vector2.up, contactFilter, resultsUp, Mathf.Infinity);
				...
				break;
			case Direction.Down:
				rb2d.Cast(Vector2.down, contactFilter, resultsDown, Mathf.Infinity);
				// Block all downward ...
			...
			case Direction.Right:
				rb2d.Cast(Vector2.right, contactFilter, resultsRight, Mathf.Infinity);
				// ...
				...
				break;
			case Direction.Left:
				rb2d.Cast(Vector2.left, contactFilter, resultsLeft, Mathf.Infinity);
				// ...
