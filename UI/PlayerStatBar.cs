...
public class PlayerStatBar : MonoBehaviour {
	...
	public void UpdateHpBar(CharacterStats player, float percent) {
	...
	public void UpdateMpBar(CharacterStats player, float percent) {
		// Update the bar's fill
		if (percent <= 0) {
			hpBar.localScale = Vector3.zero;
		}
	...
	private void UpdateHpNumbers(CharacterStats player) {
	...
	private void UpdateMpNumbers(CharacterStats player) {
